...
class OrderDetailSerializer(serializers.ModelSerializer):
    ...
    stripe_publishable_key = serializers.CharField(source='restaurant.stripe_details.get_decrypted_publishable_key', read_only=True)

    class Meta:
        model = Order
        fields = ['id', 'order_items', 'status', 'total_price', 'created_time', 'updated_time', 'device', 'restaurant','device_name','stripe_publishable_key']
